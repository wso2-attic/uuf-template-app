...
(function () {
     ...
     * @return {?Object} file
     */
    function getFile(unit, relativeFilePath, lookupTable) {
        // Check in this unit
        var file = new File(unit.path + relativeFilePath);
        ...
        for (var i = 0; i < numberOfParentUnits; i++) {
            ...
            var parentFile = new File(parentUnit.path + relativeFilePath);
    ...
    function getResourcesData(requestedResourcesUris, lookupTable) {
        ...
        for (var i = 0; i < numberOfRequestedResourcesUris; i++) {
            ...
            var resourceFile = getFile(providerUnit, relativeFilePath, lookupTable);
            if (resourceFile) {
    ...
    route = function (request, response, lookupTable, configs) {
        ...
        var cachingEnabledConfig = configs[constants.APP_CONF_CACHE_ENABLED];
