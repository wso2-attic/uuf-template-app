 ...
 *     string, LIBRARY_HANDLEBARS: string, LIBRARY_LESS: string, APP_CONF_DISPLAY_NAME: string,
 *     APP_CONF_CACHE_ENABLED: string, APP_CONF_DEBUGGING_ENABLED: string, APP_CONF_LOG_LEVEL:
 *     string, APP_CONF_WELCOME_FILE: string, APP_CONF_ERROR_PAGES: string,
 *     APP_CONF_SECURITY_CONSTRAINTS: string, UI_COMPONENT_JS_FUNCTION_ON_REQUEST: string,
 ...
 *     PAGE_DEFINITION_URI: string, PAGE_DEFINITION_LAYOUT: string, UNIT_DEFINITION_PUSHED_URIS:
 *     string, UNIT_DEFINITION_DISABLE: string}}
 */
var constants = {
    // paths
